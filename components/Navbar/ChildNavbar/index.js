...
const ChildNavbar = ({ toggle}) => {
  ...
  return (
    ...
    <Nav  scrollNav={scrollNav} >
      <NavContainer>
        <NavLink href="/">
         <NavLinkA aria-label="Pen&Pixels Home">{LogoValue === "text" ? <Link href="https://Pen&Pixels.com/"><LogoText>Pen&Pixels.</LogoText></Link> :<Logo src={LogoImage.src} alt="logo" />}</NavLinkA>
        </NavLink>
